...
unsigned int amountBind = 0;
unsigned long amountVertex = 0;
...
unsigned int oc::GLScene::AmountOfBinding() {
    unsigned int output = amountBind;
    amountBind = 0;
    return output;
}

unsigned long oc::GLScene::AmountOfVertices() {
    unsigned long output = amountVertex;
    amountVertex = 0;
    return output;
}
