...
public:
    ...
    void ApplyEffect(std::vector<Mesh>& mesh, Effect e, float value);
    void PreviewEffect(std::string& vs, std::string& fs, Effect e);
...
private:
    ...
    void PreviewGeometryEffect(std::string& vs, Effect effect);
